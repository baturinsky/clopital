...
export type Model<VariableKey = string, ConstraintKey = string> = {
  ...
  readonly constraints:
    ...
    | ([ConstraintKey] extends [string] ? Readonly<Partial<Record<ConstraintKey, Constraint>>> : never)
  ...
  readonly variables:
    ...
    | ([VariableKey] extends [string] ? Readonly<Partial<Record<VariableKey, Coefficients<ConstraintKey>>>> : never)
